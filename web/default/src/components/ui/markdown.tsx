  ...
  return (
    <div
      className={cn(
        ...
        '[&_.markdown-diagram-node]:fill-primary-container [&_.markdown-diagram-node]:stroke-primary [&_.markdown-diagram-node]:stroke-[1.5]',
        '[&_.markdown-diagram-text]:fill-primary-container-foreground [&_.markdown-diagram-text]:text-sm [&_.markdown-diagram-text]:font-medium',
        ...
        '[&_.markdown-sequence-note]:fill-warning-container [&_.markdown-sequence-note]:stroke-warning',
        '[&_.markdown-sequence-note-text]:fill-warning-container-foreground [&_.markdown-sequence-note-text]:text-xs',
