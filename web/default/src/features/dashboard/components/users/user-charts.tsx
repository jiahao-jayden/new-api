...
export function UserCharts(props: UserChartsProps) {
  ...
  }, [userData, isLoading, timeGranularity, t, topUserLimit, themeRevision])

  return (
    <div className='space-y-3'>
      <div className='flex items-center gap-1.5 overflow-x-auto overflow-y-hidden pb-1 sm:gap-2'>
        <Tabs
            ...
            >
              ...
              <div className='h-[300px] p-1.5 sm:h-96 sm:p-2'>
                {isLoading ? (
                  ...
                  spec && (
                    <VChart
                      key={`user-${chart.value}-${topUserLimit}-${resolvedTheme}-${customization.preset}-${themeRevision}`}
                      spec={{
                        ...spec,
