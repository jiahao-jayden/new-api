          ...
          <section className='space-y-3'>
            ...
            <div className='space-y-2'>
              ...
              <Table className='text-sm'>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className='px-3'>default</TableCell>
                    <TableCell className='px-3 text-right'>1.0</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className='px-3'>premium</TableCell>
                    <TableCell className='px-3 text-right'>0.5</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className='px-3'>vip</TableCell>
                    <TableCell className='px-3 text-right'>0.8</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </div>
