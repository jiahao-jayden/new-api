...
export function FormDirtyIndicator({
  ...
  return (
    <SettingsPageTitleStatusPortal>
      <span className='bg-warning-container text-warning-container-foreground inline-flex h-5 items-center gap-1.5 rounded-full px-2 text-[11px] font-medium whitespace-nowrap'>
