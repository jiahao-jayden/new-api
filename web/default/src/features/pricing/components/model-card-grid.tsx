...
export function ModelCardGrid(props: ModelCardGridProps) {
  ...
  return (
    <div className='flex flex-col gap-4 sm:gap-5'>
      ...
      {totalPages > 1 && (
        <div className='bg-surface-container-low text-muted-foreground flex flex-col items-center justify-between gap-3 rounded-2xl px-4 py-3 text-sm sm:flex-row'>
