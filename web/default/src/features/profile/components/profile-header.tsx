  ...
  if (loading) {
    return (
      <Card data-card-hover='false' className='gap-0 overflow-hidden py-0'>
        ...
        <CardContent className='grid grid-cols-3 gap-2 px-4 pb-4 sm:gap-3 sm:px-6 sm:pb-6'>
          {['balance', 'usage', 'requests'].map((key) => (
            <div key={key} className='bg-muted/40 rounded-xl px-4 py-3.5'>
    ...
    <Card data-card-hover='false' className='gap-0 overflow-hidden py-0'>
      ...
      <CardContent className='grid grid-cols-3 gap-2 px-4 pb-4 sm:gap-3 sm:px-6 sm:pb-6'>
        {stats.map((item) => (
          <div
            key={item.label}
            className='bg-muted/40 min-w-0 rounded-xl px-3 py-3 sm:px-4 sm:py-3.5'
          >
            ...
            <div className='text-foreground mt-1.5 truncate font-mono text-base font-bold tracking-normal tabular-nums sm:mt-2 sm:text-2xl'>
              {item.value}
            </div>
