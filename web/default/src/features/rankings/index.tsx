...
export function Rankings() {
  ...
  return (
    <PublicLayout showMainContainer={false}>
      <div>
        <PageTransition className='mx-auto w-full max-w-[1280px] space-y-8 px-4 pt-[var(--public-header-offset)] pb-10 sm:px-6 sm:pt-[calc(var(--public-header-offset)+1rem)] sm:pb-12 xl:px-8'>
...
function RankingsError(props: { message: string }) {
  const { t } = useTranslation()
  return (
    <div className='bg-card rounded-2xl px-6 py-12 text-center'>
