...
> = {
  emerald: {
    ...
    badge: 'bg-success-container text-success-container-foreground',
  },
  amber: {
    activeText: 'text-warning',
    activeBorder: 'border-warning',
    badge: 'bg-warning-container text-warning-container-foreground',
  },
  blue: {
    activeText: 'text-info',
    activeBorder: 'border-info',
    badge: 'bg-info-container text-info-container-foreground',
  },
  violet: {
    activeText: 'text-tertiary',
    activeBorder: 'border-tertiary',
    badge: 'bg-tertiary-container text-tertiary-container-foreground',
  },
}
...
function NumberText(props: { children: ReactNode }) {
  return <span className='text-tertiary font-medium'>{props.children}</span>
}
